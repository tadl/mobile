...
populate_summary = function (user_obj) {
        wink.byId('myaccount_summary').innerHTML = 'Greetings, <b>' + user_obj.name + '</b>!';
}
...
get_user = function (user) {
    ...
    xhr.sendData(
        'http://shamrock.lib.tadl.org:3000/api/v0/user/' + user + '.json', null, 'GET', {method: 'onsuccess'}, {method: 'onfailure'}
    );
